    ...
    public override void Init(Fish fish)
    {
        if (m_ActionType != (byte)FishClipType.CLIP_MAX)
        {
            ...
            else
            {
               ...
               if(fish.FishType==9)
                {
                    GlobalAudioMgr.Instance.PlayOrdianryMusic(Audio.OrdianryMusic.m_lansha);
                }
                else if (fish.FishType == 1)
                {
                    GlobalAudioMgr.Instance.PlayOrdianryMusic(Audio.OrdianryMusic.m_lanshaBoss);
                }
                else if (fish.FishType == 18)
                {
                    GlobalAudioMgr.Instance.PlayOrdianryMusic(Audio.OrdianryMusic.m_heisha);
                }
                else if (fish.FishType == 3)
                {
                    GlobalAudioMgr.Instance.PlayOrdianryMusic(Audio.OrdianryMusic.m_heishaBoss);
                }
                else if (fish.FishType == 20)
                {
                    GlobalAudioMgr.Instance.PlayOrdianryMusic(Audio.OrdianryMusic.m_hujing);
                }
                else if (fish.FishType == 19)
                {
                    GlobalAudioMgr.Instance.PlayOrdianryMusic(Audio.OrdianryMusic.m_hujingBoss);
                }
            }
